...
keep newid finlwt21 inclass
	append using fmld102, keep(newid finlwt21 inclass)
	append using fmld103, keep(newid finlwt21 inclass)
	append using fmld104, keep(newid finlwt21 inclass)
...
keep newid ucc amount
	append using dtbd102, keep(newid ucc amount)
	append using dtbd103, keep(newid ucc amount)
	append using dtbd104, keep(newid ucc amount)
rename amount cost
	append using expd101, keep(newid ucc cost)
	append using expd102, keep(newid ucc cost)
	append using expd103, keep(newid ucc cost)
	append using expd104, keep(newid ucc cost)
sort newid
describe
