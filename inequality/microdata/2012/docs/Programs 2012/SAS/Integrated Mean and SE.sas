  ...
  /*                                                                         */
  /*  INTRVW12 DATA -- C:\2012_CEX\INTRVW12                                  */
  /*  DIARY12 DATA -- C:\2012_CEX\DIARY12                                    */
  /*  INTSTUB2012.TXT -- C:\2012_CEX\Programs                                */
  /*                                                                         */
  /***************************************************************************/
...
/*?????????????????????????????????????????????????????????????????????????????????*/
/*??                                                                             ??*/
/*??  NOTE to Users attempting to recreate published CE tables:                  ??*/
/*??                                                                             ??*/
/*??  Due to confidentiality requirements a number of PUMD variables are         ??*/
/*??  topcoded, bottom-coded, or occassionaly have observations suppressed.      ??*/
/*??  The published tables available online or by request are derived from data  ??*/
/*??  that has not been subjected to these confidentiality measures, however.    ??*/
/*??  Because of this, tabulated values derived from the PUMD may be slightly    ??*/
/*??  different from those values found in the publicly available CE tables.     ??*/
/*??                                                                             ??*/
/*??  For more information on CE's confidentiality requirements, topcoding       ??*/
/*??  methodology, and a list of the variables subjected to these measures,      ??*/
/*??  along with their topcode, bottom-code and critical values, please see the  ??*/
/*??  Diary and Interview Users' Documentations, found alongside this sample     ??*/
/*??  program, or online at http://www.bls.gov/cex/csxmicrodoc.htm.              ??*/
/*??                                                                             ??*/
/*?????????????????????????????????????????????????????????????????????????????????*/
/*?????????????????????????????????????????????????????????????????????????????????*/
