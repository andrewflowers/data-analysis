cd C:\2009_CEX\2009_Stata\diary09
set memory 100m
...
keep newid finlwt21 inclass
	append using fmld092, keep(newid finlwt21 inclass)
	append using fmld093, keep(newid finlwt21 inclass)
	append using fmld094, keep(newid finlwt21 inclass)
...
keep newid ucc amount
	append using dtbd092, keep(newid ucc amount)
	append using dtbd093, keep(newid ucc amount)
	append using dtbd094, keep(newid ucc amount)
rename amount cost
	append using expd091, keep(newid ucc cost)
	append using expd092, keep(newid ucc cost)
	append using expd093, keep(newid ucc cost)
	append using expd094, keep(newid ucc cost)
sort newid
describe
