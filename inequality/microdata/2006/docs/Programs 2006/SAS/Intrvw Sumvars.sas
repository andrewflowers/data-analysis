...
%MACRO SUMVARS;
 ...
 %LET DRIVE = C:\2006_CEX;
  ...
  PROC CONTENTS DATA = INDATA.FMLYI&YR2NEXT.1 NOPRINT
  ...
  FILENAME PARFILE '&DRIVE.\PUSUMVARS.TXT';
  ...
  DATA FMLY (KEEP = NEWID MFNLWT21 FINLWT21 &COMPVARS);
    SET INDATA.FMLYI&YEAR2.1X (IN = IN1)
        INDATA.FMLYI&YEAR2.2 (IN = IN2)
        INDATA.FMLYI&YEAR2.3 (IN = IN3)
        INDATA.FMLYI&YEAR2.4 (IN = IN4)
        INDATA.FMLYI&YR2NEXT.1 (IN = IN5);
