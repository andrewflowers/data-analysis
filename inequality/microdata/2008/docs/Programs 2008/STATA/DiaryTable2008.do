...
keep newid finlwt21 inclass
	append using fmld082, keep(newid finlwt21 inclass)
	append using fmld083, keep(newid finlwt21 inclass)
	append using fmld084, keep(newid finlwt21 inclass)
...
keep newid ucc amount
	append using dtbd082, keep(newid ucc amount)
	append using dtbd083, keep(newid ucc amount)
	append using dtbd084, keep(newid ucc amount)
rename amount cost
	append using expd081, keep(newid ucc cost)
	append using expd082, keep(newid ucc cost)
	append using expd083, keep(newid ucc cost)
	append using expd084, keep(newid ucc cost)
sort newid
describe
