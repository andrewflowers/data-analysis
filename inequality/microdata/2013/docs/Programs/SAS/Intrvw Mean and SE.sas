  ...
  /*                                                                         */
  /*  INTRVW12 DATA -- C:\2013_CEX\INTRVW13                                  */
  /*  ISTUB2012.TXT -- C:\2013_CEX\Programs                                  */
  /*                                                                         */
  /***************************************************************************/
...
/*****************************************************************************/
/* Starting in 2013 income tax data are avaible beginning in 2013 Q2.        */
/* The 2013 program estiamtes income tax data based on four quarters         */
/* instead of the usual five.                                                */
/*****************************************************************************/

DATA STUBFILE (KEEP= COUNT TYPE LEVEL TITLE UCC SURVEY GROUP LINE);
  INFILE "&DRIVE\Programs\IStub2013.txt"
  PAD MISSOVER;
...
/*****************************************************************************/
/* Starting in 2013 estimated income tax data are avaible beginning in 		 */
/* 2013 Q2. The 2013 program estimates income tax data based on four 		 */
/* quarters of estiamted tax data and one quarter of collected data.         */                                        
/* The NTAX_ITAB dataset below, adjusts the UCC in Q1 to match those		 */
/* in Q2-Q5 realted to the new estiamted tax values                             */
/*****************************************************************************/

DATA NTAX_ITAB;
	set I&YR1..ITBI&YR1.1X;
	IF UCC = '980070' THEN UCC = '980071';
	IF UCC = '980071';
	RUN;
