  ...
  /*                                                                         */
  /*  DIARY DATA -- C:\2013_CEX\DIARY12                                      */
  /*  DSTUB2012.TXT -- C:\2013_CEX\Programs                                  */
  /*                                                                         */
  /***************************************************************************/
...
/*??  Diary Users' Documentation, found alongside this sample program, or        ??*/
/*??  online at http://www.bls.gov/cex/csxmicrodoc.htm.                          ??*/
/*??                                                                             ??*/
/*?????????????????????????????????????????????????????????????????????????????????*/
/*?????????????????????????????????????????????????????????????????????????????????*/
