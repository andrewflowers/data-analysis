...
keep newid finlwt21 inclass
	append using fmld072, keep(newid finlwt21 inclass)
	append using fmld073, keep(newid finlwt21 inclass)
	append using fmld074, keep(newid finlwt21 inclass)
...
keep newid ucc amount
	append using dtbd072, keep(newid ucc amount)
	append using dtbd073, keep(newid ucc amount)
	append using dtbd074, keep(newid ucc amount)
rename amount cost
	append using expd071, keep(newid ucc cost)
	append using expd072, keep(newid ucc cost)
	append using expd073, keep(newid ucc cost)
	append using expd074, keep(newid ucc cost)
sort newid
describe
