  ...
  /*                                                                         */
  /*  DIARY DATA -- C:\2007_CEX\DIARY07                                     */
  /*  DSTUB2007.TXT -- C:\2007_CEX\Programs                                  */
  /*                                                                         */
  /***************************************************************************/
...
DATA STUBFILE (KEEP= COUNT TYPE LEVEL TITLE UCC SURVEY GROUP LINE);
  INFILE "C:\&YEAR._CEX\Programs\DSTUB&YEAR..TXT"
  PAD MISSOVER;
...
RUN;
  ...
  /* ----------------------------------------------------------------------- */
  /* 1 READ IN THE DIARY FMLY FILES                                          */
  /* 2 READ IN THE DIARY EXPM AND DTAB FILES                                 */
...
DATA FMLY;
  SET FMLYD&YR1.1 (KEEP = NEWID INCLASS WTREP01-WTREP44 FINLWT21) 
      FMLYD&YR1.2 (KEEP = NEWID INCLASS WTREP01-WTREP44 FINLWT21) 
      FMLYD&YR1.3 (KEEP = NEWID INCLASS WTREP01-WTREP44 FINLWT21) 
      FMLYD&YR1.4 (KEEP = NEWID INCLASS WTREP01-WTREP44 FINLWT21);
...
DATA EXPD;
  SET EXPND&YR1.1 (KEEP = NEWID UCC COST)
      EXPND&YR1.2 (KEEP = NEWID UCC COST)
	  EXPND&YR1.3 (KEEP = NEWID UCC COST)
	  EXPND&YR1.4 (KEEP = NEWID UCC COST);
RUN;
...
DATA DTAB (RENAME=(AMOUNT=COST));
  SET DTABD&YR1.1 (KEEP = NEWID UCC AMOUNT)
      DTABD&YR1.2 (KEEP = NEWID UCC AMOUNT)
	  DTABD&YR1.3 (KEEP = NEWID UCC AMOUNT)
	  DTABD&YR1.4 (KEEP = NEWID UCC AMOUNT);
RUN;
